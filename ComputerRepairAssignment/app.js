...
app.get('/virusRemoval', function (req, res) {
	res.render('virusRemoval');
});

app.get('/softwareIssues', function (req, res) {
	res.render('softwareIssues');
});

app.get('/hardwareIssues', function (req, res) {
	res.render('hardwareIssues');
});
